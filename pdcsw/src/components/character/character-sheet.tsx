...
import { Download, Upload, Dice5, Save, PlusCircle, Trash2, Minus, Plus, User, Sword, FileText, Backpack, RefreshCcw } from "lucide-react";
            ...
            <header className="flex flex-col gap-4 bg-zinc-100/50 dark:bg-zinc-900/50 p-4 rounded-xl border shadow-sm z-20 backdrop-blur-md">
                <div className="flex justify-between items-center w-full">
                    <div className="flex items-center gap-2">
                        ...
                        <div className="px-3 h-8 bg-primary rounded-lg flex items-center justify-center text-primary-foreground font-bold text-xs whitespace-nowrap">by jurikarti</div>
                        <h1 className="text-xl font-bold tracking-tight hidden md:block">Драгоценные Дни</h1>
                    </div>
                    <div className="flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 w-full">
                    ...
                    <div className="space-y-1 hidden sm:block">
                        <Label className="text-[10px] uppercase text-muted-foreground font-bold">Мастер</Label>
                                ...
                                <table className="w-full text-xs min-w-[700px]">
                                    ...
                                    <tbody>
                                        {(Object.keys(equipmentSlotLabels) as Array<keyof typeof equipmentSlotLabels>).map((slot) => (
                                            <tr key={slot} className="border-b border-muted/50 last:border-0 align-bottom">
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-6">
                                    <div className="space-y-3">
                                        ...
                                        {(Object.keys(equipmentSlotLabels) as Array<keyof typeof equipmentSlotLabels>).map((slot) => (
                                            <div key={slot} className="flex gap-2 items-end">
